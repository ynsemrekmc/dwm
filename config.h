...
static char *fonts[]          = { "Iosevka NF:size=12", "NotoColorEmoji:pixelsize=12:antialias=true:autohint=true"  };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_w,          spawn,                  {.v = (const char*[]){ "firefox-sandboxed", NULL } } },
	...
	{ MODKEY|ControlMask,		XK_x,          defaultgaps,            {0} },
	...
	/* mpc and mpd related */
	{ MODKEY,			XK_odiaeresis, spawn,                  {.v = (const char*[]){ TERMINAL, "-e", "ncmpcpp", NULL } } },
	{ MODKEY,			XK_udiaeresis, spawn,                  {.v = (const char*[]){ "mpc-notify", "--show", NULL } } },
	{ MODKEY|ControlMask,		XK_udiaeresis, spawn,                  {.v = (const char*[]){ "mpc", "seek", "+10", NULL } } },
	{ MODKEY|ShiftMask,		XK_udiaeresis, spawn,                  {.v = (const char*[]){ "mpc", "volume", "+10", NULL } } },
	{ MODKEY|ControlMask,		XK_gbreve,     spawn,                  {.v = (const char*[]){ "mpc", "seek", "-10", NULL } } },
	{ MODKEY|ShiftMask,		XK_gbreve,     spawn,                  {.v = (const char*[]){ "mpc", "volume", "-10", NULL } } },
	{ MODKEY,			XK_period,     spawn,                  SHCMD("mpc next && mpc-notify") },
	{ MODKEY|ShiftMask,		XK_period,     spawn,                  SHCMD("mpc prev && mpc-notify") },
	{ MODKEY,			XK_comma,      spawn,                  SHCMD("mpc toggle && mpc-notify") },
	{ MODKEY|ShiftMask,		XK_comma,      spawn,                  SHCMD("mpcadd") },
